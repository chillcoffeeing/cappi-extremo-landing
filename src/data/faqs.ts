...
export const faqs: Faq[] = [
  {
    question: `¿Cómo inscribo a mi hijo?`,
    answer: `Desde nuestro portal de familias puedes crear tu cuenta, registrar el perfil de tu hijo y elegir el plan y la sesión que prefieras. Todo el proceso toma solo unos minutos.`,
  },
  {
    question: `¿Qué debe llevar mi hijo al plan vacacional?`,
    answer: `Ropa cómoda para moverse todo el día, gorra, protector solar, repelente y una botella de agua. La franela oficial y las comidas ya están cubiertas por la inscripción, así que no tienes que preocuparte por eso.`,
  },
  {
    question: `¿Puedo pagar en cuotas?`,
    answer: `Claro. Puedes hacer el pago completo o dividirlo en cuotas, y reportarlo por Zelle, transferencia, Binance o efectivo directamente desde el portal de familias.`,
  },
  {
  ...
  {
    question: `Mi hijo tiene una dieta especial, ¿qué hago?`,
    answer: `Cuéntanos en el formulario de inscripción sobre cualquier alergia, intolerancia o restricción alimentaria que tenga tu hijo. Nuestro equipo de cocina ajusta su menú del día a día sin que esto represente un costo extra para ti.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Tu hijo vive la experiencia sin celular, pero eso no significa que estés desconectado. Todos los días subimos fotos y actualizaciones al portal de familias, y los coordinadores de cada sesión están disponibles por WhatsApp para cualquier cosa que necesites saber.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Somos Cappi Xtremo: un equipo dedicado a crear planes vacacionales llenos de aventura, deporte y aprendizaje, en un ambiente seguro y bien supervisado.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Sí - también organizamos fiestas, eventos y animaciones a medida de tu celebración. Puedes pedir una cotización desde nuestra sección de Programas especiales.`,
  },
];
