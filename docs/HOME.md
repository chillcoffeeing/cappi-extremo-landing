...
│   ├── <SectionPattern>        (bottom="fade")
│   ├── Section 2: Filosofía    (fondo blanco)
│   ├── <SectionPattern>        (top)
│   ├── Section 3: Servicios    (fondo sections, z-10)
│   ├── <SectionPattern>        (bottom)
...
│   ├── <SectionPattern>        (top)
│   ├── Section 7: FAQ          (fondo sections, z-10, details/summary)
...
| Patrón salida | `<SectionPattern bottom="fade" />`               |
...
| Fondo          | `bg-primary`                |
| Ritmo          | `py-12 md:py-20`            |
| Patrón entrada | `<SectionPattern top />`    |
| Patrón salida  | `<SectionPattern bottom />` |
...
5. **Mantener container**: `container` siempre
